    ...
    <header className="text-center">
        <nav>
            <h1 className="bg-gradient-to-br to-orange-300 from-red-500 text-7xl p-10 text-white font-bold">
                ...
                <p className="bg-gradient-to-l to-violet-200 from-pink-200 text-base p-2 text-yellow-700 font-bold">All type of Recipes are Available here</p>
        <div className="bg-slate-800 text-white font-bold text-base p-3 space-x-2">
