...
export default function biryani(){
    return (
        <div className="mt-7 mb-7">
            ...
            <h2 className="text-3xl font-bold mt-3">Ingredients to Marinate Chicken:</h2>

            <p className="text-gray-600 mb-3">Below, you will find the illustration of the ingredients of chicken marination. Most of the spices are common. 
                ...
                <ol className="list-decimal list-inside space-y-2 text-base bg-slate-400 p-2 font-semibold">
                ...
                <h2 className="text-3xl font-bold mt-3">For Rice</h2>

                <p className="text-gray-600 mb-3">We need to do rice and chicken steps simultaneously while the chicken marinates 
                    ...
                    <p className="text-gray-600 mb-3 mt-3">Other Preps, while the chicken is marinating and the rice is cooking.</p>
                    ...
                    <h2 className="text-3xl font-bold mt-3">For Layering</h2>
